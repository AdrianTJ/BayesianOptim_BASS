...
% AUTHOR NOTE (moved out of the rendered text; was a red inline note):
% "Como transiciono de una idea a otra aqui?" -- the transition between these
% two ideas still needs a connecting sentence from the author.
