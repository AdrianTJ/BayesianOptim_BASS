...
This process begins by setting the prior distribution \green{$p(\phi \mid x)$}, which is our belief over possible values for $\phi$ before observation of the unknown $x$.
